...
|---|---|---|
| `.github/workflows/pr-checks.yml` | PR contra `main` | Construye una copia efímera y aislada de la semantic view ("candidata", derivada del número de PR), corre la suite completa contra ella y la elimina al terminar — nunca toca la de producción; check requerido por la protección de rama |
