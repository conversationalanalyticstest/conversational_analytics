...
DESCRIBE SEMANTIC VIEW CICD_DEMO.DATA.SV_PHARMA_SALES;
```

`DESCRIBE` debe listar las 3 tablas lógicas, las 2 relaciones, los 4 facts, las 9 dimensiones y
las 6 métricas definidas en [data-model.md](../data-model.md) (nombres en inglés, ver decisión
D-09 en [research.md](research.md)).
...
Debe devolver una fila con `NET_SALES > 0`, coherente con la aserción de Q-01 en
...
```sql
DROP SEMANTIC VIEW IF EXISTS CICD_DEMO.DATA.SV_PHARMA_SALES;
```
